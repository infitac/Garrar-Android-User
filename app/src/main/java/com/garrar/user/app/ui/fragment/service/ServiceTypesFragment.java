...
import com.garrar.user.app.ui.adapter.ServiceAdapter;
...
import static com.garrar.user.app.common.Constants.RIDE_REQUEST.SERVICE_TYPE;
import static com.garrar.user.app.data.SharedHelper.getKey;
import static com.garrar.user.app.data.SharedHelper.getProviders;
import static com.garrar.user.app.data.SharedHelper.putKey;
                ...
                if (ServiceTypesFragment.this.isVisible()) {
                    ...
                    if (response.body() != null) {
                        ...
                        if (walletAmount == 0) walletBalance.setVisibility(View.GONE);
                            ...
                            walletBalance.setText(SharedHelper.getKey(getActivity(), "currency") + " " + Double.parseDouble(String.valueOf(walletAmount)));
                        }
                        if (surge == 0) {
