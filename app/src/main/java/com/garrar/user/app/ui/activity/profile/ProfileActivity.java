...
import com.garrar.user.app.ui.activity.change_password.ChangePasswordActivity;
...
public class ProfileActivity extends BaseActivity implements ProfileIView {
 ...
 //               fbOtpVerify(mCountry.getCode(), mCountry.getDialCode(), "");
    ...
    private void updateDetails() {
        ...
        if((oldMobileNumber == null && !mobile.getText().toString().isEmpty()) || !mobile.getText().toString().equals(oldMobileNumber)) {
    ...
    public void onUpdateFailure(Throwable e) {
        ...
        Toasty.error(this, "Mobile number already exists.", Toast.LENGTH_SHORT).show();
    }
