...
import static com.garrar.user.app.base.BaseActivity.getNumberFormat;
import static com.garrar.user.app.base.BaseActivity.getTwoDecimalNumberFormat;
...
public class ServiceAdapter extends RecyclerView.Adapter<ServiceAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder,
        ...
        if (estimateFare != null) {
            ...
            holder.estimated_fixed.setText(SharedHelper.getKey(context, "currency") + " " + Double.parseDouble(String.valueOf(estimateFare.getEstimatedFare() - 3)) + "-" + SharedHelper.getKey(context, "currency") + " " + Double.parseDouble(String.valueOf(estimateFare.getEstimatedFare() + 5)));
...
//                    getNumberFormat().format(Double.parseDouble(String.valueOf(estimateFare.getEstimatedFare() - 3))) + "-" + getTwoDecimalNumberFormat().format(Double.parseDouble(String.valueOf(estimateFare.getEstimatedFare() + 5))));
        ...
        if (position == lastCheckedPos && canNotifyDataSetChanged) {
            ...
            if (estimateFare != null) {
                ...
                String str =  SharedHelper.getKey(context, "currency") + " " +Double.parseDouble(String.valueOf(estimateFare.getEstimatedFare() + 5));
                holder.estimated_fixed.setText(SharedHelper.getKey(context, "currency") + " " +
                        Double.parseDouble(String.valueOf(estimateFare.getEstimatedFare() - 3)) + "-" +str);
//                holder.estimated_fixed.setText(SharedHelper.getKey(context, "currency") + " " +
//                        getNumberFormat().format(Double.parseDouble(String.valueOf(estimateFare.getEstimatedFare() - 3))) + "-" + getTwoDecimalNumberFormat().format(Double.parseDouble(String.valueOf(estimateFare.getEstimatedFare() + 5))));
