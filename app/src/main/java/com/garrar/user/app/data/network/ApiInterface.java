...
import com.garrar.user.app.data.network.model.TelrAddWallet;
...
import com.garrar.user.app.data.network.model.Coupon;
...
import com.garrar.user.app.data.network.model.Rental;
...
public interface ApiInterface {
    ...
    @Multipart
    @POST("api/user/update_all_courier_data")
    Observable<JSONObject> updatepackagedata(@PartMap() Map<String, RequestBody> partMap, @Part MultipartBody.Part filename);
    ...
    Observable<SendRequest> sendRequest(@FieldMap HashMap<String, Object> params);
