...
import com.garrar.user.app.ui.activity.past_trip_detail.PastTripDetailActivity;
    ...
    private class TripAdapter extends RecyclerView.Adapter<TripAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
            ...
            if (payment != null) {
                ...
                holder.payable.setText(SharedHelper.getKey(mContext, "currency") + " " + payment.getTotal());
            }
