...
import com.garrar.user.app.ui.activity.view_courie_detail.ViewCourierDetailActivity;
...
import com.garrar.user.app.data.network.model.Rating;
import com.garrar.user.app.ui.fragment.InvoiceDialogFragment;
import com.garrar.user.app.ui.fragment.dispute.DisputeCallBack;
import com.garrar.user.app.ui.fragment.dispute.DisputeFragment;
import com.garrar.user.app.ui.fragment.dispute_status.DisputeStatusFragment;
import com.garrar.user.app.ui.fragment.lost_item.LostFragment;
import com.garrar.user.app.ui.fragment.lost_item_status.LostItemStatusFragment;
    ...
    public void onSuccess(List<Datum> pastTripDetails) {
        ...
        if (datum != null) {
            ...
            Glide.with(baseActivity())
                    ...
                    .into(staticMap);
            tv_add.setText(datum.getSAddress());
            tv_add_dest.setText(datum.getDAddress());
            if(MvpApplication.DATUM.getPackageInfos().size() == 3){
                tv_add1.setText(MvpApplication.DATUM .getPackageInfos().get(1).getPAddress());
                tv_add2.setText(MvpApplication.DATUM .getPackageInfos().get(2).getPAddress());
                ll_add1.setVisibility(View.VISIBLE);
                ll_add2.setVisibility(View.VISIBLE);
            }else if(MvpApplication.DATUM.getPackageInfos().size() == 2){
                tv_add1.setText(MvpApplication.DATUM .getPackageInfos().get(1).getPAddress());
                ll_add1.setVisibility(View.VISIBLE);
            }
            ...
            if (payment != null)
                payable.setText(SharedHelper.getKey(baseActivity(), "currency") + " " + payment.getTotal());
        }
    }
