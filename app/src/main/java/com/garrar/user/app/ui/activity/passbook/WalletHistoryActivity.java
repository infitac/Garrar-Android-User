...
import com.garrar.user.app.data.network.model.Wallet;
    ...
    private class WalletHistoryAdapter extends RecyclerView.Adapter<MyViewHolder> {
        ...
        public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
           ...
           /* holder.tvAmountVal.setText(String.format("%s %s", SharedHelper.getKey(WalletHistoryActivity.this, "currency"),
            ...
            holder.tvAmountVal.setText(SharedHelper.getKey(baseActivity(), "currency") + " " + item.getAmount());
            holder.tvBalanceVal.setText(SharedHelper.getKey(baseActivity(), "currency") + " " + item.getCloseBalance());
        }
