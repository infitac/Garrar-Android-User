...
import com.garrar.user.app.ui.activity.forgot_password.ForgotPasswordActivity;
...
public class PasswordActivity extends BaseActivity implements LoginIView {
    ...
    public void onError(Throwable e) {
       ...
       // handleError(e);  // Need to make enable for SMTP
        Toast.makeText(this, "Need to Setup SMTP Server!", Toast.LENGTH_SHORT).show();
        hideLoading();
    }
