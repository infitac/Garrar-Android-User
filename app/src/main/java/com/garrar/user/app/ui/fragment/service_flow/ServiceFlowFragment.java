package com.garrar.user.app.ui.fragment.service_flow;
...
import com.garrar.user.app.ui.fragment.cancel_ride.CancelRideDialogFragment;
...
import com.garrar.user.app.common.CancelRequestInterface;
...
import com.garrar.user.app.data.network.model.ProviderService;
...
public class ServiceFlowFragment extends BaseFragment
    ...
    @OnClick({R.id.sos, R.id.cancel, R.id.share_ride, R.id.call, R.id.chat, R.id.ic_info})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.chat:
                ...
                break;
            case R.id.ic_info:
                ViewCourierDetailFragment viewCourierDetailFragment = new ViewCourierDetailFragment();
                ((MainActivity) Objects.requireNonNull(getActivity())).changeFragment(viewCourierDetailFragment);
                break;
        }
    }
