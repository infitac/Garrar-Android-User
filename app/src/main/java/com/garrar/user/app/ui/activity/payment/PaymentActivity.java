...
//import com.mobiz.user.telr.TelrHelper;
...
import static com.garrar.user.app.common.Constants.PaymentMode.CASH;
...
import static com.garrar.user.app.ui.fragment.invoice.InvoiceFragment.isInvoiceCashToCard;
...
//                finishResult(PAYTM);
    ...
    public void onSuccess(List<Card> cards) {
        ...
        for (int i = 0; i < cards.size(); i++) {
            ...
            MvpApplication.RIDE_REQUEST.put(CARD_ID, cards.get(i).getCardId());
        }
