...
import com.garrar.user.app.ui.activity.OnBoardActivity;
import com.garrar.user.app.ui.activity.login.EmailActivity;
import com.garrar.user.app.ui.activity.login.PasswordActivity;
import com.garrar.user.app.ui.activity.register.RegisterActivity;
import com.garrar.user.app.ui.activity.social.SocialLoginActivity;
import com.garrar.user.app.ui.activity.splash.SplashActivity;
...
import com.garrar.user.app.common.CustomDialog;
...
//    protected LatLng mDefaultLocation = new LatLng(23.0225, 72.5714);
...
//        String currencyCode = SharedHelper.getKey(MvpApplication.getInstance(), "currency_code", "LIRA");
        String currencyCode = SharedHelper.getKey(MvpApplication.getInstance(), "currency_code", "");
        @SuppressLint({"NewApi", "LocalSuppress"})
        Locale trlocale = Locale.forLanguageTag("ar-eg");
        NumberFormat numberFormat = NumberFormat.getCurrencyInstance(trlocale);
//        numberFormat.setCurrency(Currency.getInstance(currencyCode));
//        numberFormat.setCurrency(Currency.getInstance(Loc));
    ...
    protected void initPayment(String mode, TextView paymentMode, ImageView paymentImage) {
        ...
        switch (mode) {
            ...
            case Constants.PaymentMode.CARD:
                String text = getString(R.string.card);
